describe("BTC page spec", () => {
    it("clicking on bitcoin token directs the user to the correct token page publicly", () => {
    const tokenShort = "BTC"; // defining the token abbreviation variable
    const tokenName = "Bitcoin"; // defining the token name variable
