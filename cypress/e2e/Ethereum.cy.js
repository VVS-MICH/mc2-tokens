describe("ETH page spec", () => {
    it("clicking on Ethereum token directs the user to the correct token page publicly", () => {
        const tokenShort = "ETH"; // defining the token abbreviation variable
        const tokenName = "Ethereum"; // defining the token name variable
